  ...
  return (
    <div className="bg-white text-zinc-950 min-h-screen">
      ...
      <div className="flex min-h-screen">
        {/* Sidebar - simplified */}
        <aside className="w-[260px] shrink-0 bg-neutral-50 border-r border-zinc-200 hidden lg:flex flex-col">
          <div className="flex items-center gap-2.5 px-6 border-b border-zinc-200 h-[72px]">
            <Link href="/" className="flex items-center gap-2">
              <div className="size-9 rounded-lg bg-[#ff6900] flex items-center justify-center">
                <Construction className="size-5 text-orange-50" />
              </div>
              <div>
                <p className="font-bold text-zinc-950 text-sm leading-tight">Prathmikta Setu</p>
                <p className="text-[#71717b] text-[11px]">Bridging Citizens &amp; Governance</p>
              </div>
            </Link>
          </div>
          <div className="p-4 flex flex-col gap-0.5">
            {["Dashboard","Heatmap","Analytics","Complaints","Recommendations","Priority Scores","Budget Optimizer","Emergency Alerts","Digital Twin","Reports","Settings"].map((item, i) => (
              <Link
                key={item}
                href="#"
        ...
        <div className="flex flex-col flex-1 min-w-0">
          {/* Header */}
          <header className="sticky top-0 z-20 bg-white/95 backdrop-blur border-b border-zinc-200 flex px-8 justify-between items-center h-[72px]">
            <div className="flex items-center gap-2 text-sm text-[#71717b]">
              <Link href="/issues" className="hover:text-zinc-950">Issues</Link>
              <ChevronRight className="size-4" />
              <Link href="#" className="hover:text-zinc-950">Roads &amp; Infrastructure</Link>
              <ChevronRight className="size-4" />
              <span className="font-medium text-zinc-950">Severe Pothole &amp; Waterlogging on MG Road</span>
            </div>
            <div className="flex items-center gap-2">
              <button className="rounded-lg border border-zinc-200 px-3 py-1.5 text-sm flex items-center gap-2 hover:bg-zinc-50">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2 flex-wrap">
                          <span className="font-semibold rounded-full bg-[#ff6900]/10 text-[#ff6900] text-xs px-2.5 py-0.5 flex items-center gap-1">
                            <Flame className="size-3 mr-1" />High Priority
                          </span>
                        ...
                        <h1 className="font-bold text-2xl tracking-tight">Severe Pothole &amp; Waterlogging on MG Road</h1>
                      </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-6 flex flex-col gap-4">
                  ...
                  <ol className="relative flex flex-col">
                    {[
                      ...
                      <li key={step.label} className={`relative flex gap-4 ${i < arr.length - 1 ? "pb-6" : ""}`}>
                        {i < arr.length - 1 && (
                ...
                <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-6 flex flex-col gap-4">
                  ...
                  {[
                    {
                      ...
                      role: "Resident",
                      time: "2 days ago",
                      comment: "This junction is genuinely dangerous after rain. Thank you for taking it up so quickly — please prioritise the drainage as well, not just the surface patch.",
                      likes: 24,
                      official: {
                        name: "PWD Roads Division",
                        time: "1 day ago",
                        reply: "Noted. A dedicated drainage survey has been added to the work order. Resurfacing crew is scheduled for this week.",
                      },
                    },
                    {
                      initials: "PM",
                    ...
                    <div key={comment.name} className="flex gap-3">
                      ...
                      <div className="rounded-xl border border-zinc-200 flex p-4 flex-col flex-1 gap-2">
                        ...
                        <div className="flex items-center gap-4 pt-1">
                          <button className="text-[#71717b] text-xs flex items-center gap-1.5">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex flex-1 gap-2">
                      ...
                      />
                      <button className="size-10 rounded-xl bg-[#ff6900] flex items-center justify-center hover:bg-orange-600 transition-colors">
                ...
                <div className="sticky top-24 flex flex-col gap-4">
                  ...
                  <div className="bg-[#ff6900]/5 rounded-2xl border border-[#ff6900]/20 p-5">
                    ...
                    <p className="text-[#71717b] text-xs leading-relaxed">
                      This issue has a priority score of <strong className="text-zinc-950">89/100</strong>. Affects an estimated
                      6,200 daily commuters. Road resurfacing combined with drainage repair recommended for lasting resolution.
                    </p>
                  </div>
                </div>
              </div>
