 ...
 * Renders track content WITHOUT DashboardLayout — CitizenLayout provides the nav.
 */
...
export default function CitizenTrackPage() {
  return (
    <div className="max-w-[820px] mx-auto flex flex-col gap-6">
      <div>
        <h1 className="font-bold text-xl tracking-tight">Track Complaint</h1>
        <p className="text-[#71717b] text-sm mt-0.5">Public Grievance Tracker · Real-time status</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-5 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="bg-[#ff6900] font-semibold rounded-xl text-orange-50 px-5 gap-2 h-11 flex items-center hover:bg-orange-600 transition-colors text-sm shrink-0">
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-5 flex flex-col gap-4">
        <div className="flex flex-wrap justify-between items-start gap-3">
          ...
          <span className="bg-[#ff6900]/10 text-[#ff6900] font-semibold rounded-full text-sm px-3 py-1.5 flex items-center gap-1.5 shrink-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-[#F8FAF8] rounded-xl border border-zinc-200 flex p-4 flex-col gap-2">
            ...
            <span className="text-[#ff6900] font-bold text-base leading-tight">Work In Progress</span>
          ...
          <div className="bg-[#F8FAF8] rounded-xl border border-zinc-200 flex p-4 flex-col gap-2">
            ...
            <span className="font-bold text-base leading-tight">Public Works Dept.</span>
          ...
          <div className="bg-[#1E8E3E]/5 rounded-xl border border-[#1E8E3E]/30 flex p-4 flex-col gap-2">
            ...
            <span className="text-[#1E8E3E] font-bold text-base leading-tight">18 Feb 2024</span>
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-5 flex flex-col gap-4">
        <div>
          <h2 className="font-bold text-base tracking-tight">Complaint Timeline</h2>
          <p className="text-[#71717b] text-xs">Every stage is logged transparently.</p>
        </div>
        ...
        {[
          ...
          { icon: UserCheck,   done: true,   label: "Assigned",    desc: "Routed to Public Works Dept., Ward 12 · Officer S. Verma.", time: "10 Feb 2024 · 11:02 AM" },
          ...
          return (
            <div key={step.label} className="flex gap-4">
              <div className="flex flex-col items-center">
                <div className={`size-9 shrink-0 rounded-full flex justify-center items-center ${
                  step.done   ? "bg-[#1E8E3E] text-white" :
                  step.active ? "bg-[#ff6900] text-orange-50 ring-4 ring-[#ff6900]/20" :
              ...
              <div className={`flex pt-1 flex-col ${i < arr.length - 1 ? "pb-5" : ""}`}>
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="font-semibold text-sm">{step.label}</span>
                  {step.done    && <span className="bg-[#1E8E3E]/10 text-[#1E8E3E] rounded-full text-[10px] px-2 py-0.5">Done</span>}
                  {step.active  && <span className="bg-[#ff6900]/10 text-[#ff6900] rounded-full text-[10px] px-2 py-0.5">Active</span>}
                  {step.pending && <span className="rounded-full text-[#71717b] text-[10px] border border-zinc-200 px-2 py-0.5">Pending</span>}
                </div>
                <span className="text-[#71717b] text-xs mt-0.5">{step.desc}</span>
                {step.time && (
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-5 flex flex-col gap-4">
        <div>
          ...
          <p className="text-[#71717b] text-xs">Notifications shared by the assigned department.</p>
        </div>
        {[
          { icon: Hammer,    iconBg: "bg-[#ff6900]/10", iconColor: "text-[#ff6900]", title: "Work commenced on site",           time: "14 Feb · 08:30 AM", desc: "Machinery deployed for drainage clearing. Estimated 3 working days for full road resurfacing.", dept: "Public Works Dept., Ward 12",   deptColor: "text-[#ff6900]" },
          { icon: UserCheck, iconBg: "bg-[#1E8E3E]/10", iconColor: "text-[#1E8E3E]", title: "Complaint assigned to field officer", time: "10 Feb · 11:02 AM", desc: "Officer S. Verma has been assigned and conducted a preliminary site inspection.",                    dept: "Constituency Grievance Cell",  deptColor: "text-[#1E8E3E]" },
          { icon: BadgeCheck,iconBg: "bg-[#1E8E3E]/10", iconColor: "text-[#1E8E3E]", title: "Complaint verified & accepted",      time: "08 Feb · 04:40 PM", desc: "AI and officer verification complete. Issue categorized as High Priority.",                          dept: "AI Classification System",     deptColor: "text-[#1E8E3E]" },
        ].map((update) => {
