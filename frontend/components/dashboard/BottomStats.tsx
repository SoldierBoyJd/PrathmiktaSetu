...
export default function BottomStats() {
  return (
    // 1 col on mobile → 2 cols on sm → 4 cols on xl
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-5">
        ...
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0 relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-[10px] font-bold text-zinc-950 leading-none">12,842</span>
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-zinc-200 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center gap-1">
          ...
          <div className="text-xs text-[#71717b]">Average</div>
          <div className="flex items-center gap-1 mt-2 text-xs text-[#1E8E3E]">
            <TrendingDown size={12} />
            <span>↓ 1.2d vs last 30 days</span>
          </div>
        </div>
      </div>
          ...
          <div className="relative w-24 h-24">
            <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
              ...
              <circle
                ...
                stroke="#1E8E3E"
                strokeWidth="10"
                strokeDasharray={`${(78 / 100) * 251.2} 251.2`}
                strokeLinecap="round"
              />
            </svg>
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-zinc-200">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="flex flex-col items-center gap-2 p-3 rounded-xl bg-[#ff6900]/5 hover:bg-[#ff6900]/10 transition-colors border border-[#ff6900]/20">
            <Send size={18} className="text-[#ff6900]" />
            <span className="text-[10px] font-medium text-[#ff6900] text-center leading-tight">
              Submit Complaint
            </span>
          </button>
          <button className="flex flex-col items-center gap-2 p-3 rounded-xl bg-[#1E8E3E]/5 hover:bg-[#1E8E3E]/10 transition-colors border border-[#1E8E3E]/20">
            <RefreshCw size={18} className="text-[#1E8E3E]" />
            <span className="text-[10px] font-medium text-[#1E8E3E] text-center leading-tight">
              Generate Report
            </span>
          </button>
          <button className="flex flex-col items-center gap-2 p-3 rounded-xl bg-red-50 hover:bg-red-100 transition-colors border border-red-100">
            <Send size={18} className="text-red-500" />
            <span className="text-[10px] font-medium text-red-500 text-center leading-tight">
              Broadcast Alert
            </span>
          </button>
          <button className="flex flex-col items-center gap-2 p-3 rounded-xl bg-[#1E88E5]/5 hover:bg-[#1E88E5]/10 transition-colors border border-[#1E88E5]/20">
            <Download size={18} className="text-[#1E88E5]" />
            <span className="text-[10px] font-medium text-[#1E88E5] text-center leading-tight">
              Download Data
            </span>
          </button>
        </div>
